...
exports.createSubadmin = async (name, surname, mail, pass, admin_id, comp_id) => {

    try {
        await pool.query(
            `INSERT INTO subadmin(name, surname, password, mail, admin_id, comp_id) VALUES($1, $2, $3, $4, $5, $6)`,
